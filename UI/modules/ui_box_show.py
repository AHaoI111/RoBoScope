...
class Dialog(QDialog):
    ...
    def __init__(self, parent=None, slide_task=None, slide_points=None, ):
        ...
        self.select_1_flag = 0
        self.select_2_flag = 0
        self.select_3_flag = 0
        self.select_4_flag = 0
        self.checkbox_map_1 = {
        ...
        self.ui.pushButton_reset_1.clicked.connect(self.select_1)
        self.ui.pushButton_reset_2.clicked.connect(self.select_2)
        self.ui.pushButton_reset_3.clicked.connect(self.select_3)
        self.ui.pushButton_reset_4.clicked.connect(self.select_4)
        self.ui.pushButton_save.clicked.connect(self.save_slide_setting)
        self.flash()

    def select_1(self):
        if self.select_1_flag == 0:
            for key, checkbox in self.checkbox_map_1.items():
                checkbox.setChecked(True)
            self.select_1_flag = 1
        else:
            for key, checkbox in self.checkbox_map_1.items():
