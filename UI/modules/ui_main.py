...
"                 ")
        ...
        self.horizontalLayout_37 = QHBoxLayout(self.test)
        ...
        self.pushButton_test_get_slide.setMinimumSize(QSize(120, 30))
        self.pushButton_test_get_slide.setMaximumSize(QSize(120, 30))
        ...
        self.pushButton_test_put_slide.setMinimumSize(QSize(120, 30))
        self.pushButton_test_put_slide.setMaximumSize(QSize(120, 30))
        ...
        self.pushButton_test_move_2_singleview_center.setMinimumSize(QSize(120, 30))
        self.pushButton_test_move_2_singleview_center.setMaximumSize(QSize(120, 30))
        ...
        self.verticalLayout_28.addWidget(self.pushButton_test_move_2_singleview_center)
        ...
        self.pushButton_test_move_2_lowview_center.setMinimumSize(QSize(120, 30))
        self.pushButton_test_move_2_lowview_center.setMaximumSize(QSize(120, 30))
        ...
        self.pushButton_test_move_2_highview_center.setMinimumSize(QSize(120, 30))
        self.pushButton_test_move_2_highview_center.setMaximumSize(QSize(120, 30))
        ...
        self.horizontalLayout_37.addLayout(self.verticalLayout_29)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 569, 823))
        ...
        self.horizontalLayout_37.addWidget(self.scrollArea)
...
"    }")
        ...
        self.page.setGeometry(QRect(0, 0, 296, 769))
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/images/icons/cil-media-play.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_run.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/images/icons/cil-media-pause.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_pause.setIcon(icon13)
...
"    }")
        ...
        self.page_2.setGeometry(QRect(0, 0, 296, 655))
