            ...
            if self.config['Device']['cameranumber'] == 1:
                ...
                if letters_only == 'FCU':
                    ...
                    if len(self.config['Camera']['single']['wbone']) != 3:
                        ...
                        self.camera.set_wb_ratios(self.config['Camera']['single']['wbone']['R'], self.config['Camera']['single']['wbone']['G'],
                ...
                if letters_only == 'FCU':
                    ...
                    if len(self.config['Camera']['low']['wblow']) != 3:
                        ...
                        self.camera1.set_wb_ratios(self.config['Camera']['low']['wblow']['R'], self.config['Camera']['low']['wblow']['G'],
                                                   self.config['Camera']['low']['wblow']['B'])
                # 设置拍摄区域
                offset_x = (508 // 8) * 8
                offset_y = (14 // 8) * 8
                self.camera1.set_ROI(offset_x, offset_y, 3008, 3008)
                # 设置曝光时间和增益
                ...
                if letters_only == 'FCU':
                    if len(self.config['Camera']['high']['wbhigh']) != 3:
                        ...
                        self.camera2.set_wb_ratios(self.config['Camera']['high']['wbhigh']['R'], self.config['Camera']['high']['wbhigh']['G'],
                                                   self.config['Camera']['high']['wbhigh']['B'])
                self.camera2.set_ROI(offset_x, offset_y, 3008, 3008)
